    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "",
            "Je dispose du permis C et de la FIMO.",
            "",
            "Je précise que je n’ai pas encore de carte conducteur en cours de validité ; je voulais savoir si l’entreprise peut prendre en charge cette demande.",
            "",
            "Cordialement,",
            "Julien",
            "",
